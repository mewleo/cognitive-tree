...
describe('KnowledgeTree', () => {
  ...
  describe('结晶提议', () => {
    it('应找到满足结晶条件的节点', () => {
      tree.addNode(new KnowledgeNode({ node_id: 'cry1', axis: '业', state: '实', summary: '可结晶节点', children_ids: ['x1', 'x2', 'x3'] }));
    ...
    it('不应提议高阶节点结晶', () => {
      tree.addNode(new KnowledgeNode({ node_id: 'high1', axis: '思', state: '实', summary: '高阶原理', level: 3, children_ids: ['y1', 'y2', 'y3'] }));
  ...
  describe('跨干关联发现', () => {
    it('应发现不同主干但有相同隐性标签的节点', () => {
      tree.addNode(new KnowledgeNode({ node_id: 'work1', axis: '业', state: '实', summary: '代码模块分离', implicit_tags: ['解耦'] }));
      tree.addNode(new KnowledgeNode({ node_id: 'life1', axis: '生', state: '实', summary: '家庭分工明确', implicit_tags: ['解耦', '边界'] }));
      tree.addNode(new KnowledgeNode({ node_id: 'thought1', axis: '思', state: '虚', summary: '哲学中的分与合', implicit_tags: ['解耦'] }));
  ...
  describe('大内容渲染', () => {
    it('长内容节点应显示 📄 标记', () => {
      const node = tree.addNote('A'.repeat(150));
  ...
  describe('ASCII 渲染', () => {
    ...
    it('应展示干支叶层级关系', () => {
      tree.addNode(new KnowledgeNode({ node_id: 'parent1', axis: '业', state: '实', summary: '父节点', children_ids: ['child1', 'child2'] }));
  ...
  describe('序列化与反序列化', () => {
    ...
    it('fromJSON 空数据应返回空树', () => {
      const t = KnowledgeTree.fromJSON([]);
